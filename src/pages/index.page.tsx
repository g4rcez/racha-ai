    ...
    return (
        <div className="flex h-screen overflow-x-hidden w-screen flex-auto flex-col bg-white text-slate-700">
                ...
                <div className="space-y-4 text-balance py-12 px-4">
                    <header>
                        ...
                        <p className="text-lg font-light leading-relaxed pt-8 lg:pt-0">
                            ...
                            <Link href={links.index} className="font-normal hover:underline text-main-bg">
                                racha aí
                            </Link>
            ...
            <section className="flex flex-col items-center justify-center my-12">
                ...
                <p className="text-balance max-w-2xl text-center">
                    O <span className="text-main-bg">Racha aí</span> é o app ideal para você dividir sua conta com a
                    galera. Você nunca mais vai ter que pagar a mais num lugar sem comanda.
                </p>
            </section>
        </div>
    );
