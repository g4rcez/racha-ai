    ...
    <div className="flex h-screen w-screen flex-auto flex-col overflow-x-hidden bg-white text-slate-700">
        ...
        <div className="space-y-4 text-balance px-4 lg:py-12">
          <header>
            ...
            <p className="pt-8 text-lg font-light leading-relaxed lg:pt-0">
              ...
              <Link
                href={links.index}
                className="font-normal text-main-bg hover:underline"
              >
                racha aí
              </Link>
          ...
          {preferences.name === "" ? (
            <Form
              encType="json"
              method="post"
              className="container flex max-w-lg items-end gap-2"
            >
              <Input
            ...
            <Link
              className="my-6 flex flex-col items-center gap-2 text-xl"
              href={links.app}
            >
      ...
      <section className="my-12 flex flex-col items-center justify-center gap-6 px-4">
        ...
        <p className="max-w-2xl text-balance text-center">
          O <span className="text-main-bg">Racha aí</span> é o app ideal para
          você dividir sua conta com a galera. Você nunca mais vai ter que pagar
          a mais num lugar sem comanda. Diga adeus as comandas de uma mesa que
