...
const links = [
  {
    title: "LinkedIn",
    href: "https://linkedin.com/in/allan-garcez",
    Icon: LinkedinIcon,
  },
  {
    title: "Github",
    href: "https://github.com/g4rcez/racha-ai",
    Icon: GithubIcon,
  },
  {
    title: "Twitter",
    ...
    <footer className="border-t border-gray-200">
      <Container>
        <div className="flex flex-col items-start justify-between gap-y-12 pb-6 pt-16 lg:flex-row lg:items-center lg:py-16">
          ...
          <ul className="relative gap-2 gap-y-6 justify-center lg:justify-start flex-wrap flex items-center self-stretch p-4 transition-colors sm:self-auto sm:rounded-2xl lg:mx-0 lg:self-auto lg:p-6">
            {links.map((link) => (
              <li key={`footer-link-${link.href}`}>
                <a
                  href={link.href}
                  className="flex flex-row items-center gap-2 hover:underline p-2 hover:bg-gray-100"
                >
                  <link.Icon />
                  {link.title}
                </a>
        ...
        <div className="flex flex-col items-center flex-wrap border-t border-gray-200 pb-12 pt-8 md:flex-row-reverse md:justify-between md:pt-6">
