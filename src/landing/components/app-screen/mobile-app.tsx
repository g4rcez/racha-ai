...
import { features } from "~/landing/components/app-screen/app-features";
        ...
        <Fragment>
            ...
            >
                {features.map((feature, featureIndex) => (
                    <div key={featureIndex} ref={(ref: any) => ref && (slideRefs.current[featureIndex] = ref!)} className="w-full flex-none snap-center px-4 sm:px-6">
                        <div className="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                                <CircleBackground color={colors.brand} className={featureIndex % 2 === 1 ? "rotate-180" : undefined} />
                            </div>
