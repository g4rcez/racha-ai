...
const variants = cva("flex flex-col gap-2 p-4 rounded border border-transparent", {
    variants: {
        theme: {
...
export type AlertProps<T extends React.ElementType = "button"> = PolymorphicProps<
    Variants & Partial<{ icon: Label; title: Label }>,
    T
>;
