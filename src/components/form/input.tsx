...
export type InputProps = InputFieldProps<"input"> & TheMaskProps & FeedbackProps;

export const Input: React.FC<InputProps> = forwardRef<HTMLInputElement, InputProps>(
    ({ type = "text", container, rightLabel, optionalText, hideLeft = false, right, left, ...props }: InputProps, ref): any => {
